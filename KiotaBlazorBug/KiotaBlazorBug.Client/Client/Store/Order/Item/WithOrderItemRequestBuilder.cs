...
using System;
namespace KiotaBlazorBug.Client.Store.Order.Item
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::KiotaBlazorBug.Client.Store.Order.Item.WithOrderItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::KiotaBlazorBug.Client.Models.Order?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::KiotaBlazorBug.Client.Models.Order> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::KiotaBlazorBug.Client.Store.Order.Item.WithOrderItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::KiotaBlazorBug.Client.Store.Order.Item.WithOrderItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
